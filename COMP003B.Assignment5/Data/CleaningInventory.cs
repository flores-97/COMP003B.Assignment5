...
namespace COMP003B.Assignment5.Data
{
    public class CleaningInventory
    {
        public static List<CleaningBrand> CleaningBrands { get; } = new()
        {
            ...
            new CleaningBrand { Id =1, Name = "Windex", Quantity = 1, Price = 2.99m },
            new CleaningBrand { Id =1, Name = "Ajax", Quantity = 4, Price = 5.99m },
            new CleaningBrand { Id =1, Name = "Fabuloso", Quantity = 7, Price = 15.99m },
        };
    }
}